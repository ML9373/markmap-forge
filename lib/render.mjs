...
const VARIANT_LABEL = { exhaustive: "Exhaustive", light: "Light" };

export function deriveOutputName(data) {
	if (data.output) return data.output;
	return `${slugify(data.source_name)}_${data.variant}.html`;
}
...
export function renderMindmap(data) {
	...
	const html = template
		...
		.replace("[INSERT_VARIANT_LABEL]", VARIANT_LABEL[data.variant])
